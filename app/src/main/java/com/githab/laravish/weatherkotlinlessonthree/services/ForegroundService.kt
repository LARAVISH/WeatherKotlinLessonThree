...
import com.githab.laravish.weatherkotlinlessonthree.INTENT_ACTION_KEY
import com.githab.laravish.weatherkotlinlessonthree.INTENT_SERVICE_DATA
...
class ForegroundService : Service(), CoroutineScope by MainScope() {
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val notificationChannel = NotificationChannel("some_channel",
                "Progress",
